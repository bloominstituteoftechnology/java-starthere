package local.skylerwebdev.starter.logging;
...
{
    @Around(value = "@within(local.skylerwebdev.starter.logging.Loggable) || @annotation(local.skylerwebdev.starter.logging.Loggable)")
